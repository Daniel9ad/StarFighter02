...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AProyectil_OnHit_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// Es llamado cuando el objeto coliciona con otro\n" },
		{ "ModuleRelativePath", "Proyectil.h" },
		{ "ToolTip", "Es llamado cuando el objeto coliciona con otro" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProyectil_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProyectil_OnHit, "OnHit" }, // 3390134665
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AProyectil, 1947629392);
